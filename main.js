...
SuperEarth = function(dom, opt) {
  ...
  let renderer = new THREE.WebGLRenderer({ canvas: this.canvas, context: this.canvas.getContext( 'webgl2' ), antialias: true });
  ...
  textureLoader.crossOrigin = true;
  textureLoader.load('img/starfield.png',
    function(texture) {
